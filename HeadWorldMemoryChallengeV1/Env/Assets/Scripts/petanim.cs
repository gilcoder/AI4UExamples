...
public class petanim : RLAgent
{
    ...
    {        
        ...
        UpdateRaysMatrix(eye.transform.position + 1.5f * gameObject.transform.forward, gameObject.transform.forward, gameObject.transform.up, gameObject.transform.right, 75);
